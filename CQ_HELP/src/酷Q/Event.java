...
返回非零值,消息将被拦截,最高优先不可拦截
     */
    消息_ EVE_GroupMsg(int subType, int msgId, long fromGroup, long fromQQ,
...
返回非零值,消息将被拦截,最高优先不可拦截
     */
    消息_ EVE_GroupUpload(int subType, int sendTime, long fromGroup,
            long fromQQ, string file
    );
...
返回非零值,消息将被拦截,最高优先不可拦截
     */
    消息_ EVE_System_GroupMemberDecrease(int subType, int sendTime,
            long fromGroup, long fromQQ, long beingOperateQQ
    );
